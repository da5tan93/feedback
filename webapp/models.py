...
class Product(models.Model):
    ...
    category = models.ForeignKey(blank=False, null=False, choices='webapp.Categories',
...
class Review(models.Model):
    author = models.ForeignKey(null=True, blank=True, default=None, verbose_name='Автор',
                               on_delete=models.CASCADE, related_name='comments')
    product = models.ForeignKey('webapp.Product', verbose_name='Товар')
